...
map2 :: ∀ a b c f. (Apply f) => (a -> b -> c) -> f a -> f b -> f c
map2 = lift2
...
map3 :: ∀ a b c d f. (Apply f) => (a -> b -> c -> d) -> f a -> f b -> f c -> f d
map3 = lift3
...
map4 :: ∀ a b c d e f. (Apply f) => (a -> b -> c -> d -> e) -> f a -> f b -> f c -> f d -> f e
map4 = lift4
...
map5 :: ∀ a b c d e f g. (Apply f) => (a -> b -> c -> d -> e -> g) -> f a -> f b -> f c -> f d -> f e -> f g
map5 = lift5
