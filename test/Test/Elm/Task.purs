...
tests = suite "Elm.Task" do
    ...
    test "Task.toMaybe" do
        ...
        good <- toAff do toMaybe (succeed 42)
        good === Right (Just 42) :: Either Unit (Maybe Int)

    test "Task.fromMaybe" do
        error <- toAff do fromMaybe "file not found" Nothing
        error === Left "file not found" :: Either String Int

        good <- toAff do fromMaybe "file not found" (Just 42)
        good === Right 42 :: Either String Int
    ...
    test "Task.toResult" do
        ...
        good <- toAff do toResult (succeed 42)
        good === Right (Ok 42) :: Either Unit (Result String Int)
    ...
    test "Task.sequence" do
        good <- toAff (sequence (succeed 1 : succeed 2 : succeed 3 : Nil))
        good === Right (1 : 2 : 3 : Nil) :: Either String (List Int)

        bad <- toAff (sequence (succeed 1 : fail "No" : succeed 3 : Nil))
        bad === Left "No"
    ...
    test "Task FFI" do
        good <- toAff $ evenAfter50 12
        good === Right 12 :: Either String Int

        bad <- toAff $ evenAfter50 13
        bad === Left "Not even or divisible by 3"
        
        ugly <- try $ toAff $ evenAfter50 3
        case ugly of
            Left ex ->
                message ex === "Divisible by 3"
