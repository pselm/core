...
tests = do
    test "conversion" do
        assert "fromString good" <| toMaybe (Elm.Debug.log "fromString" (fromString "May 27, 2014 00:00 CDT")) == Elm.Debug.log "from millis" (fromEpochMilliseconds (Milliseconds 1401166800000.0))
